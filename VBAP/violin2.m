...
[violin_2, violin2_fs] = audioread('/Users/virginiablancoravena/Desktop/Universidad/2021-2022/2_cuatri/MEDS/Lab3/VBAP/violin/QUARTET_violin2.wav');
[samples, cols] = size(violin_2);
...
alpha1 = linspace(25,-50,num_samples1+1);
alpha2 = linspace(-50,0,num_samples2+1);
alpha3 = linspace(0,50,num_samples3+1);
alpha4 = linspace(50,100,num_samples4+2);

alpha5 = linspace(100,25,num_samples5+2);
...
Y_violin2 = VBAP_pan(violin_2, alpha_vector);
Y_7_violin2 = nat6to71(Y_violin2);
audiowrite('/Users/virginiablancoravena/Desktop/Universidad/2021-2022/2_cuatri/MEDS/Lab3/VBAP/violin2.wav',Y_7_violin2, violin2_fs);
plot(Y_violin2);
