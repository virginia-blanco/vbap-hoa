...
[violin_1, violin1_fs] = audioread('/Users/virginiablancoravena/Desktop/Universidad/2021-2022/2_cuatri/MEDS/Lab3/VBAP/violin/QUARTET_violin1.wav');
[samples, cols] = size(violin_1);
...
alpha1 = linspace(75,0,num_samples1+1);
alpha2 = linspace(0,50,num_samples2+1);
alpha3 = linspace(50,100,num_samples3+1);
alpha4 = linspace(100,150,num_samples4+2);
alpha5 = linspace(150,75,num_samples5+2);
...
Y_violin1 = VBAP_pan(violin_1, alpha_vector);
Y_7_violin1 = nat6to71(Y_violin1);
audiowrite('/Users/virginiablancoravena/Desktop/Universidad/2021-2022/2_cuatri/MEDS/Lab3/VBAP/violin1.wav',Y_7_violin1, violin1_fs);
plot(Y_violin1);
